...
const IMAGES: GalleryImage[] = [
  {
    ...
    description: 'Angular NgRx Material Starter is a great community built Angular starter'
  },
  {
    src: '../../../../assets/images/open-source/angular-starter/contributors.jpg',
    alt: 'Angular NgRx Material Starter - Contributors',
    description: 'Angular NgRx Material Starter was built by more than 30 contributors'
  },
  {
    src: '../../../../assets/images/open-source/angular-starter/todos.jpg',
    alt: 'Angular NgRx Material Starter - Todos example',
    description: 'Angular NgRx Material Starter has many built in examples including simple TODO app'
  },
  {
    ...
    description: 'Angular NgRx Material Starter has I18n support with runtime language switching'
  },
  {
    src: '../../../../assets/images/open-source/angular-starter/ngrx.jpg',
    alt: 'Angular NgRx Material Starter - NgRx example',
    description: 'Angular NgRx Material Starter comes with proper NgRx 8 example CRUD implementation (together with reactive forms)'
  }
];

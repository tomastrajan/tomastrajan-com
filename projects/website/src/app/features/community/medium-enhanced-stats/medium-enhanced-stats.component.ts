...
const IMAGES: GalleryImage[] = [
  {
    ...
    description: 'Medium Enhanced Stats total reach popup gives you your total stats overview from anywhere'
  },
  {
    src: '../../../../assets/images/community/medium-enhanced-stats/export.jpg',
    alt: 'Medium Enhanced Stats total reach popup actions',
    description: 'Medium Enhanced Stats allows you to export your stats as csv and download your total reach to share with your fans'
  },
  {
    src: '../../../../assets/images/community/medium-enhanced-stats/summary.jpg',
    alt: 'Medium Enhanced Stats summary row',
    description: 'Medium Enhanced Stats gives you a summary row with the total values'
  },
  {
  ...
  },
  {
    ...
    description: 'Medium Enhanced Stats gives you ability to visualize article contribution to the total daily views'
  },
  {
    ...
    description: 'Medium Enhanced Stats marks day when you published articles directly in the main chart'
  },
  {
    src: '../../../../assets/images/community/medium-enhanced-stats/milestone.gif',
    alt: 'Medium Enhanced Stats milestone reached animation',
    description: 'Medium Enhanced Stats motivates you to write more by setting goals and milestones. Once reached, there must be a celebration right?'
  }
];
